...
/**
 * @author Chi Exception class for IFC data format problems.
 */
...
public class IfcDataFormatException extends Exception {
  ...
  public static IfcDataFormatException attributeOutOfBounds(String lineNumber) {
    String messageFormat =
        "Attribute out of bounds in line %1s: Object in IFC files has more attributes than it is allowed";
   ...
   *
   * @param lineNumber express id or entire line of the IFC object which references to the
   *     non-existing object
   * @param wrongLineNumber the express id of the non-existing object
   * @return
   */
  public static IfcDataFormatException referencingNonExistingObject(
      String lineNumber, String wrongLineNumber) {
    String messageFormat =
        "Referencing to non-existing object in line %1s: Reference to non-existing line number %2s";
   ...
   * @return
   */
  public static IfcDataFormatException valueOutOfRange(
      String lineNumber, String wrongValue, String valueType) {
